...
namespace HoloLensCameraModule
{
    public static class CoordinateTransfer
    {
        ...
        /// <returns></returns>
        public static bool ImagePos2WorldPos(float x, float y, float imageHeight, float imageWidth, Matrix4x4 projectionMatrix, Matrix4x4 cameraToWorldMatrix, out Vector3 positionOnWorldCordinate)
        {
            ...
            if (Physics.Raycast(cameraPos, worldSpacePos - cameraPos, out hit, 20f, 1 << 31))
            {
        ...
        {
            //see https://developer.microsoft.com/en-us/windows/holographic/locatable_camera
